...
## CLI Commands (26)
check, validate, passes-gate, init, report, status, spec, acceptance, performance, security, contract, review, command, sync-docs, knowledge, sdd, failure, posteval-plan, update-user-model, release, analyze-sessions, constraints, constraints report, constraints retire, doc-freshness-check, spec-baseline-check
